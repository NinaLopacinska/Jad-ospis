<?php
session_start();
if (!isset($_SESSION['logged_in']) || $_SESSION['user_type'] != 'Administrator') {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#">Konto administratora</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><hr class="dropdown-divider" /></li>
                            <li><a class="dropdown-item" href="formularzDodajPracownika.php">Dodaj pracownika</a></li>
                            <li><a class="dropdown-item" href="usunKontoAdmin.php">Usuń użytkownika</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
