...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    header('Location: mainLogowanie.php'); // Przekieruj niezalogowanego użytkownika na stronę logowania
    exit();
}
?>
<!DOCTYPE html>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="">Konto ucznia</a></li>
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="">Jadłospis</a></li>
                    <li class="nav-item"><a class="nav-link" href="komentarze.php">Komentarze</a></li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="zmianaDanychUczen.php">Zmień hasło</a></li>
                            <li><a class="dropdown-item" href="usunKontoUczen.php">Usuń konto</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
